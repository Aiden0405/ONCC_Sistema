...
def create_app(config_class=Config):
    ...
    from app.blueprints.core.controllers.roles import rol_editar as core_rol_editar, rol_eliminar as core_rol_eliminar, rol_gestionar_permisos as core_rol_gestionar_permisos, rol_index as core_rol_index, rol_nuevo as core_rol_nuevo, rol_permisos_index as core_permisos_index, rol_permiso_nuevo as core_permiso_nuevo
    ...
    # Logística
    from app.blueprints.logistica.controllers.inventario import acta_responsabilidad as logistica_inventario_acta, editar as logistica_inventario_editar, eliminar as logistica_inventario_eliminar, inventario_index as logistica_inventario_index, nuevo as logistica_inventario_nuevo, nuevo_movimiento as logistica_inventario_nuevo_movimiento, editar_movimiento as logistica_inventario_editar_movimiento, eliminar_movimiento as logistica_inventario_eliminar_movimiento, reporte_inventario as logistica_inventario_reporte, reporte_movimientos as logistica_inventario_reporte_movimientos
    from app.blueprints.logistica.controllers.tecnicos_campo import tecnicos_nuevo as logistica_tecnicos_nuevo, tecnicos_editar as logistica_tecnicos_editar, tecnicos_eliminar as logistica_tecnicos_eliminar
    ...
    app.add_url_rule('/inventario/reporte-movimientos', endpoint='inventario.reporte_movimientos', view_func=logistica_inventario_reporte_movimientos)
    ...
    def dashboard():
        ...
        actividades = Actividad.query.order_by(Actividad.fecha_actividad.desc()).limit(5).all()
